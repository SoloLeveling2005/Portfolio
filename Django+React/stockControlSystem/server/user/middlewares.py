...
from user.serializers import RegisterLoginSerializer


def authorization(func):
    def wrapper(instance, *args, **kwargs):
        serializer = RegisterLoginSerializer(data=instance.request.headers)
        serializer.is_valid(raise_exception=True)
        print(str(serializer.data['Authorization']).lower())
